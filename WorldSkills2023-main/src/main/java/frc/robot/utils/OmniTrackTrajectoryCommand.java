 ...
 * the onboard
 * PID functionality of a "smart" motor controller) may use the secondary
 * constructor that omits
 * the PID and feedforward functionality, returning only the raw wheel speeds
 * from the PID
 * controllers.
 *
 * <p>
...
public class OmniTrackTrajectoryCommand extends CommandBase {
  ...
  public void execute() {
    ...
    // m_prevSpeeds = new ChassisSpeeds(targetXVel, targetYVel,
    // 0);//targetAngularVel);
